"""
Adapted 2D UNETR++ as seen in: https://arxiv.org/abs/2212.04497
...
class TransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv51 = UnetResBlock(2, hidden_size, hidden_size, kernel_size=3, 
...
class UnetrPPEncoder(nn.Module):
    def __init__(self, 
        ...
        stem_layer = nn.Sequential(
            ...
            get_norm_layer(name=("group", {"num_groups": 1}), # in_channels}), 
                           channels=dims[0]),
        )
