...
class ResNet3d(BaseModel):
    ...
    def forward(self, x, enc_only=False): 
        ...
        feature_maps_l = [
            self.layer0_hook.features,
            self.layer1_hook.features,
            self.layer2_hook.features,
            self.layer3_hook.features,
            self.layer4_hook.features,
        ]
        return {
